            ...
            <div class="card-header">
                <div class="card-product-info">
                    ...
                    <div class="card-details">
                        ...
                        <p class="card-sku">SKU: <?php echo e($product->sku); ?></p>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="card-info-grid">
                    <div class="card-info-item">
                        ...
                        <span class="card-value"><?php echo e($product->category?->name ?? '-'); ?></span>
                    </div>
                    <div class="card-info-item">
                        <span class="card-label">Quantity</span>
                        <span
                              class="card-value quantity <?php echo e($product->quantity <= 0 ? 'quantity-out' : ($product->is_low_stock ? 'quantity-low' : 'quantity-normal')); ?>">
                    ...
                    <div class="card-info-item">
                        ...
                        <span class="card-value">₱<?php echo e(number_format($product->selling_price, 2)); ?></span>
                    </div>
                    <div class="card-info-item">
                        <span class="card-label">Cost</span>
                        <span class="card-value">₱<?php echo e(number_format($product->cost_price, 2)); ?></span>
                    </div>
                </div>
            </div>
