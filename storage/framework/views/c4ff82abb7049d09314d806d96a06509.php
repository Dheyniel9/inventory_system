                    ...
                    <div class="flex items-center gap-x-4 lg:gap-x-6">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button type="button" @click="open = !open" class="-m-1.5 flex items-center p-1.5">
                                <img class="h-8 w-8 rounded-full bg-gray-50" src="<?php echo e(auth()->user()->avatar_url); ?>" alt="">
                                <span class="hidden lg:flex lg:items-center">
                                    <span class="ml-4 text-sm font-semibold text-gray-900"><?php echo e(auth()->user()->name); ?></span>
                            ...
                            <div x-show="open" @click.outside="open = false" x-transition
                                ...
                                <a href="<?php echo e(route('profile')); ?>" class="block px-3 py-1 text-sm text-gray-900 hover:bg-gray-50">Profile</a>
                                <form method="POST" action="<?php echo e(route('logout')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="block w-full px-3 py-1 text-left text-sm text-gray-900 hover:bg-gray-50">Sign out</button>
                                </form>
                            </div>
                        </div>
                    </div>
