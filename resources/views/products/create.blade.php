        ...
        <div class="form-section">
            ...
            <div class="form-grid">
                ...
                <x-form-group name="sku"
                              ...
                              error="{{ $errors->has('sku') ? $errors->first('sku') : false }}" />
                ...
                <x-form-group name="category_id"
                              label="Category"
                              type="select"
                              :options="isset($categories) ? collect($categories)->pluck('name', 'id')->toArray() : []"
        ...
        <div class="form-section">
            ...
            <div class="form-grid form-grid-3">
                ...
                <x-form-group name="quantity"
                              ...
                              required
                              error="{{ $errors->has('quantity') ? $errors->first('quantity') : false }}" />
