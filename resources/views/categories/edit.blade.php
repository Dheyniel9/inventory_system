...
<div class="space-y-6">
    ...
    <form action="{{ route('categories.update', $category) }}" method="POST" class="rounded-lg bg-white shadow">
        @csrf @method('PUT')
        <div class="space-y-6 p-6">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm">{{ old('description', $category->description) }}</textarea>
