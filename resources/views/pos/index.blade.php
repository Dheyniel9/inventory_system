            ...
            <div class="flex-1 overflow-y-auto p-4">
                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                    ...
                    <button type="button"
                        ...
                        <div
                             class="w-16 h-16 mb-2 rounded-lg bg-gray-100 flex items-center justify-center overflow-hidden">
                        ...
                        <span class="text-sm font-bold text-primary-600 mt-1">${{ number_format($product->selling_price,
                            2) }}</span>
                        <span
                              class="text-xs {{ $product->quantity <= $product->min_stock_level ? 'text-yellow-600' : 'text-gray-400' }}">
                    ...
                    <div class="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                        ...
                        <div class="flex items-center gap-2">
                            <button @click="decrementQty(index)"
                                    class="w-7 h-7 flex items-center justify-center rounded bg-gray-200 hover:bg-gray-300 text-gray-600">
                                <svg class="w-4 h-4"
                                     fill="none"
                                     viewBox="0 0 24 24"
                                     stroke="currentColor">
            ...
            <div class="border-t p-4 space-y-3 bg-gray-50">
                ...
                <div class="space-y-3 pt-3">
                    ...
                    <div x-show="paymentMethod === 'cash'">
                        ...
                        <p class="text-sm mt-1"
                           x-show="change >= 0">
                            Change: <span class="font-semibold text-green-600"
                ...
                <div class="flex gap-2 pt-3">
                    <button @click="clearCart()"
                            type="button"
                            class="flex-1 py-2 px-4 rounded-md border border-gray-300 text-gray-700 hover:bg-gray-100">
                        Clear
                    </button>
    ...
    <div x-show="showSuccessModal"
        ...
        <div class="flex min-h-screen items-center justify-center p-4">
            ...
            <div class="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6 text-center">
                ...
                <p class="text-gray-600 mb-2">Invoice: <span class="font-mono font-semibold"
                ...
                <p class="text-gray-600"
                   x-show="lastSale?.change_amount > 0">Change: <span class="font-semibold text-green-600"
