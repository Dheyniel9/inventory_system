    ...
    <div class="user-form">
      <div class="user-grid">
        ...
        <div>
          <div class="user-form-group">
            <label for="password"
                   class="user-form-label">New Password</label>
            <input type="password"
                   name="password"
                   id="password"
                   class="user-form-input">
            <p class="user-form-hint">Leave blank to keep current password</p>
        ...
        <div>
          <div class="user-form-group">
            <label for="password_confirmation"
                   class="user-form-label">Confirm New Password</label>
            <input type="password"
        ...
        <div class="user-grid-full">
          <div class="user-form-group">
            <label class="user-form-label">Current Avatar</label>
            <div style="display: flex; align-items: center; gap: 1rem; margin-top: 0.25rem;">
              <img style="width: 4rem; height: 4rem; border-radius: 9999px; object-fit: cover;"
                   src="{{ $user->avatar_url }}"
                   alt="">
              <div style="display: flex; align-items: center;">
                ...
                <label for="remove_avatar"
                       style="margin-left: 0.5rem; font-size: 0.875rem; color: #dc2626;">Remove current avatar</label>
              </div>
            </div>
          </div>
        </div>
        ...
        <div {{
             $user->avatar ? '' : 'class="user-grid-full"' }}>
          <div class="user-form-group">
            <label for="avatar"
                   class="user-form-label">{{ $user->avatar ? 'New Avatar' : 'Avatar' }}</label>
            <input type="file"
                   name="avatar"
                   id="avatar"
                   accept="image/*"
      ...
      <div class="user-form-actions">
        ...
        <button type="submit"
                class="user-btn user-btn-submit">Update User</button>
      </div>
    </div>
  </form>
</div>
