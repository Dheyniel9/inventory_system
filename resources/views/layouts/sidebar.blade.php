...
<script>
    ...
    document.querySelector('.stock-toggle')?.addEventListener('click', function() {
        const submenu = document.querySelector('.stock-submenu');
    ...
    // POS toggle
    document.querySelector('.pos-toggle')?.addEventListener('click', function() {
        const submenu = document.querySelector('.pos-submenu');
        const chevron = this.querySelector('.chevron-icon');
        submenu.classList.toggle('submenu-visible');
        submenu.classList.toggle('submenu-hidden');
        chevron.classList.toggle('rotate');
