...
<div class="space-y-6">
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      ...
      <p class="mt-1 text-sm text-gray-500">Create a new supplier</p>
    </div>
  ...
  <form action="{{ route('suppliers.store') }}"
    ...
    <div class="flex justify-end gap-3 border-t px-6 py-4">
      ...
      <button type="submit"
              class="rounded-md bg-primary-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary-500">Create</button>
    </div>
  </form>
</div>
@endsection
